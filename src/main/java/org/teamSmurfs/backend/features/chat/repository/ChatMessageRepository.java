package org.teamSmurfs.backend.features.chat.repository;
...
public interface ChatMessageRepository extends JpaRepository<ChatMessage, Long> {
    ...
    @Query("""
        SELECT new org.teamSmurfs.backend.features.dashboard.dto.DashboardChatMessage(m.sender.username, m.content, m.timestamp)
        FROM ChatMessage m
        JOIN m.chatRoom cr
