package org.teamSmurfs.backend.features.react.repository;
...
public interface ReactJdbcRepository {
    ...
    void updateReaction(final Long authorId, final String reaction, final Long entityId, final Integer entityType);
}
